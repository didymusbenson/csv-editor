...
function addTinyMCE() {
    ...
    tinymce.init({
        ...
        plugins: [
                    ...
                    'insertdatetime media table contextmenu paste table code help'
                ],
        toolbar: 'insert | undo redo |  styleselect | bold italic backcolor  | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformat | code | table | help',
        convert_urls: false,
